...
define('COMPONENT_IMAGES_URL', JURI::root().'components/'.COMPONENT_OPTION.'/assets/images/');
define('COMPONENT_IMAGES_PATH', JPATH_SITE.'/components/'.COMPONENT_OPTION.'/assets/images/');
define('COMPONENT_CSS_URL', JURI::root().'components/'.COMPONENT_OPTION.'/assets/css/');
define('COMPONENT_JS_URL', JURI::root().'components/'.COMPONENT_OPTION.'/assets/js/');
define('COMPONENT_ADMIN_JS_URL', JURI::root().'administrator/components/'.COMPONENT_OPTION.'/assets/js/');
define('COMPONENT_MOBILE_LIB_URL', JUri::root() . 'components/' . COMPONENT_OPTION . '/assets/mobile/');
...
define('COMPONENT_MEDIA_URL', JURI::root().'media/'.COMPONENT_OPTION.'/');
