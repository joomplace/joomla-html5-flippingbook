...
//==================================================
class JFormField_Upload_Audio extends JFormField_Upload_File
{
	protected $type = '_upload_audio';
...
//		$this->noImageUrl = JURI::root() . ($this->element['noImageUrl'] ? $this->element['noImageUrl'] : 'administrator/components/'.COMPONENT_OPTION.'/assets/thumbnails/no_image.png');
		$this->listTitle = ($this->element['listTitle'] ? $this->element['listTitle'] : 'COM_HTML5FLIPPINGBOOK_BE_SELECT_SOUND');
		...
		$this->fileExtensions = ($this->element['fileExtensions'] ? $this->element['fileExtensions'] : 'mp3,wav,wma');
