...
// $contents = array('0' =>"<div class='image1'><img src='' data-src='/media1/illustrations/cloud01.png' /></div><div class='left'><p class='drop-cap'></p></div><div class='right'><p class='continuation'>Some test text</p></div>",'1' =>"<div class='left'><p class='continuation'>Some test text</p></div><div class='right'>Some test text</p></div>",'2' =>"<p>Some test text</p><div class='spacer' /><p class='continuation'><em>Some test text</em></p><p class='continuation'><em>Some test text</em></p>");
...
echo $currentView; echo $currentArticle; echo $currentArticlePage; 
